...
private:
	...
	field_t applyMovingSolid(field_t &population, const uint_t cellDirection) {
		...
		auto getLatticeVelocity = [](const uint_t spatialDirection, const uint_t cellDirection) { return (spatialDirection * nCellDirections) + cellDirection; };
